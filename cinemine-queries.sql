...
INSERT INTO movies(movie_id, movie_title, movie_year, movie_genre, ent_id) VALUES (1, 'The Dark Knight', 2008, 'Action', 1);
INSERT INTO movies(movie_id, movie_title, movie_year, movie_genre, ent_id) VALUES (1, 'The Dark Knight', 2008, 'Action', 2);
INSERT INTO movies(movie_id, movie_title, movie_year, movie_genre, ent_id) VALUES (2, 'Inception', 2010, 'Action', 2);
INSERT INTO movies(movie_id, movie_title, movie_year, movie_genre, ent_id) VALUES (2, 'Inception', 2010, 'Action', 3);
INSERT INTO movies(movie_id, movie_title, movie_year, movie_genre, ent_id) VALUES (3, 'Django Unchained', 2012, 'Drama', 3);
INSERT INTO movies(movie_id, movie_title, movie_year, movie_genre, ent_id) VALUES (3, 'Django Unchained', 2012, 'Drama', 4);
INSERT INTO movies(movie_id, movie_title, movie_year, movie_genre, ent_id) VALUES (3, 'Django Unchained', 2012, 'Drama', 5);
INSERT INTO movies(movie_id, movie_title, movie_year, movie_genre, ent_id) VALUES (4, 'Joker', 2019, 'Crime', 6);
INSERT INTO movies(movie_id, movie_title, movie_year, movie_genre, ent_id) VALUES (4, 'Joker', 2019, 'Crime', 7);
INSERT INTO movies(movie_id, movie_title, movie_year, movie_genre, ent_id) VALUES (5, 'Spirited Away', 2001, 'Adventure', 8);
INSERT INTO movies(movie_id, movie_title, movie_year, movie_genre, ent_id) VALUES (5, 'Spirited Away', 2001, 'Adventure', 9);

INSERT INTO entertainer(ent_id, ent_name, ent_prof, movie_id) VALUES (1, 'Christian Bale', 'Actor', 1);
INSERT INTO entertainer(ent_id, ent_name, ent_prof, movie_id) VALUES (2, 'Christopher Nolan', 'Director', 1);
INSERT INTO entertainer(ent_id, ent_name, ent_prof, movie_id) VALUES (2, 'Christopher Nolan', 'Director', 2);
INSERT INTO entertainer(ent_id, ent_name, ent_prof, movie_id) VALUES (3, 'Leonardo Dicaprio', 'Actor', 2);
INSERT INTO entertainer(ent_id, ent_name, ent_prof, movie_id) VALUES (3, 'Leonardo Dicaprio', 'Actor', 3);
INSERT INTO entertainer(ent_id, ent_name, ent_prof, movie_id) VALUES (4, 'Quentin Tarantino', 'Director', 3);
INSERT INTO entertainer(ent_id, ent_name, ent_prof, movie_id) VALUES (5, 'Jamie Foxx', 'Actor', 3);
INSERT INTO entertainer(ent_id, ent_name, ent_prof, movie_id) VALUES (6, 'Todd Phillips', 'Director', 4);
INSERT INTO entertainer(ent_id, ent_name, ent_prof, movie_id) VALUES (7, 'Joaquin Phoenix', 'Actor', 4);
INSERT INTO entertainer(ent_id, ent_name, ent_prof, movie_id) VALUES (8, 'Hayao Miyazaki', 'Director', 5);
INSERT INTO entertainer(ent_id, ent_name, ent_prof, movie_id) VALUES (9, 'Daveign Chase', 'Actor', 5);
INSERT INTO entertainer(ent_id, ent_name, ent_prof, movie_id) VALUES (9, 'Daveign Chase', 'Director', 5);
...
INSERT INTO watchlist(movie_id, user_id, user_rating, user_comment, comment_id) --comment_id should be an incrementing variable
    SELECT movies.movie_id, user.user_id, 5, 'it was ok', 1
    FROM movies, user
...
UPDATE ratings
    SET avg_rating = ((avg_rating*num_ratings) + 5) / (num_ratings + 1), num_ratings = num_ratings + 1
...
UPDATE ratings
    SET avg_rating = ((avg_rating*num_ratings) + 3) / num_ratings
    WHERE movie_id = (select movie_id from movies where movie_title = 'The Dark Knight');
...
SELECT DISTINCT movies.movie_title as num15
    FROM movies
    JOIN entertainer ON entertainer.ent_id = movies.ent_id 
...
SELECT DISTINCT movie_title as num16
    FROM movies
    JOIN entertainer ON movies.ent_id = entertainer.ent_id
...
.headers on
SELECT movie_title, movie_year, movie_genre, avg_rating, num_ratings, ent_name as actor
    FROM movies, ratings, entertainer
    WHERE movies.movie_id = ratings.movie_id AND
    movies.ent_id = entertainer.ent_id AND
...
SELECT DISTINCT ent_name, movie_title as num20
    FROM movies
    JOIN principles ON movies.ent_id = principles.ent_id

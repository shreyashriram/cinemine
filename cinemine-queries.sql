...
INSERT INTO entertainer(ent_id, ent_name) VALUES (1, 'Christian Bale');
INSERT INTO entertainer(ent_id, ent_name) VALUES (2, 'Christopher Nolan');
INSERT INTO entertainer(ent_id, ent_name) VALUES (2, 'Christopher Nolan');
INSERT INTO entertainer(ent_id, ent_name) VALUES (3, 'Leonardo Dicaprio');
INSERT INTO entertainer(ent_id, ent_name) VALUES (3, 'Leonardo Dicaprio');
INSERT INTO entertainer(ent_id, ent_name) VALUES (4, 'Quentin Tarantino');
INSERT INTO entertainer(ent_id, ent_name) VALUES (5, 'Jamie Foxx');
INSERT INTO entertainer(ent_id, ent_name) VALUES (6, 'Todd Phillips');
INSERT INTO entertainer(ent_id, ent_name) VALUES (7, 'Joaquin Phoenix');
INSERT INTO entertainer(ent_id, ent_name) VALUES (8, 'Hayao Miyazaki');
INSERT INTO entertainer(ent_id, ent_name) VALUES (9, 'Daveign Chase');
INSERT INTO entertainer(ent_id, ent_name) VALUES (9, 'Daveign Chase');
...
SELECT DISTINCT movie_title as num16
    ...
    JOIN principles ON movies.movie_id = principles.movie_id
    JOIN entertainer ON principles.ent_id = entertainer.ent_id
    WHERE job_role = 'Director' AND ent_name = 'Christopher Nolan';
...
SELECT DISTINCT movie_title, movie_year, movie_genre, avg_rating, num_ratings, ent_name as actor
    ...
    job_role = 'Actor' AND movie_title = 'The Dark Knight';
